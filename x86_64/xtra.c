...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "area");
 	...
 	ivoc_help("help ?1 xtra /users/rdvanderstoep/Documents/VNS_Simulation_Learning/xtra.mod\n");
...
static void _modl_cleanup(){ _match_recurse=1;}
 ...
 static void _ba1(Node*_nd, double* _pp, Datum* _ppd, Datum* _thread, NrnThread* _nt)  {
    _p = _pp; _ppvar = _ppd;
  v = NODEV(_nd);
 ex = is1 * rx1 + is2 * rx2 + is3 * rx3 + is4 * rx4 + is5 * rx5 ;
   }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/users/rdvanderstoep/Documents/VNS_Simulation_Learning/xtra.mod";
static const char* nmodl_file_text = 
  ...
  "NEURON {\n"
  "	SUFFIX xtra\n"
  "	RANGE rx1, rx2, rx3, rx4, rx5: (es = max amplitude of the potential)		\n"
  "	RANGE x, y, z, type, order\n"
  "	GLOBAL is1, is2, is3, is4, is5: (stim = active electrode, amp = stimulation amplitude)\n"
  "	POINTER ex \n"
  "}\n"
  "\n"
  "PARAMETER {	\n"
